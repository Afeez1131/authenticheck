"""
Django settings for Authenticheck project.
...
MIDDLEWARE = [
    ...
    'Authenticheck.middlewares.UserHasBusinessMiddleware',
]

ROOT_URLCONF = 'Authenticheck.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'Authenticheck/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Authenticheck.wsgi.application'
